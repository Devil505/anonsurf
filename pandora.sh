...
# Default-Stop:         0 1 6
# Short-Description: Open Solus Pandora's box and clean the RAM.
### END INIT INFO

#
# Lorenzo "EclipseSpark" Faletra <eclipse@frozenbox.org>
#         Solus Security OS www.Solussec.org
#                      GNU/GPL v3
#

function bomb {
	echo "starting Solus Pandora's box "
	sleep 5
    ...
    sdmem -fllv
    echo " - RAM bombed"
    echo "closing Solus Pandora's box"
}
